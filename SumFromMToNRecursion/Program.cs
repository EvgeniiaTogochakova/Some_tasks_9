...
if (check)
{
    ...
    Console.WriteLine("Считаю сумму этих чисел и всех натуральных чисел в промежутке между ними: " + sum);
}
else Console.WriteLine("Второе число должно было быть больше предыдущего!");